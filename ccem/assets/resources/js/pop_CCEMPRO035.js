...
const onModify = () => {
	...
	switch (proc) {
		case "6":
			PopupUtil.open("CCEMPRO022", 1154, 630, "#tchrIntrdTab");	// 선생님소개 탭
			break;
		case "5":
			PopupUtil.open("CCEMPRO022", 1154, 630, "#entrRgtrTab");	// 입회등록 탭
			break;
		default:
			PopupUtil.open("CCEMPRO022", 1154, 630, "#counselRgtrTab");	// 상담등록 탭
			break;
	}
