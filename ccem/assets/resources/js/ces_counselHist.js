...
$(function(){
	...
	$(".popup-btn").click(function() {
		...
		if(popDepth == '2'){
			...
			w = 500;
			h = 660;
			console.log(counselListPop);
			if(counselListPop.name != "" && counselListPop.name != null){
				counselListPop.focus();
				counselListPop.exitAlert(popName,w,h);
			}else {
...
function openUnPop(popName,w,h){
	console.log(popName);
	counselListPop = window.open('pop_'+popName+'.html',popName,'width='+w+', height='+h+', toolbar=no, menubar=no, scrollbars=no, resizable=no');
};
